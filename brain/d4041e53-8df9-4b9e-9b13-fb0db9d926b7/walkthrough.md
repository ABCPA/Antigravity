...
### Compilation
The code has been inserted and a compilation check was triggered (`scripts/capture-vba-compile-error.ps1`).
A full performance and compilation test (`scripts/sgq-perf.ps1`) was subsequently executed and passed successfully (Exit Code 0), confirming zero compilation errors and stable VBIDE access.
